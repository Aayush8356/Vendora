...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-white flex items-center justify-center px-4 py-8">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join us and start your premium shopping experience</p>
        </div>
