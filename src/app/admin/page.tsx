        ...
        >
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                <span className="text-gray-900">Premium Headphones</span>
                <span className="text-red-600 font-medium">2 left</span>
              </div>
              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                <span className="text-gray-900">Leather Wallet</span>
                <span className="text-orange-600 font-medium">5 left</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-gray-900">Smart Watch</span>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                <span className="text-gray-900">Smart Watch</span>
                <span className="text-green-600 font-medium">134 sold</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-gray-900">Designer Sunglasses</span>
                <span className="text-green-600 font-medium">98 sold</span>
              </div>
            </div>
          </div>
        </motion.div>
